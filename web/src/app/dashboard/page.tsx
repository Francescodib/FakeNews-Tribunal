      ...
      <main className="mx-auto max-w-5xl px-4 py-8 space-y-8">
        ...
        <section className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex flex-wrap gap-3 items-end">
              ...
              <div>
                <label className="block text-xs font-medium text-slate-600 mb-1">Max rounds</label>
                <input
                  type="number"
                  min={1}
                  max={10}
        ...
        <section>
          <h2 className="text-lg font-semibold text-slate-900 mb-3">
            History {total > 0 && <span className="text-slate-400 font-normal text-sm">({total})</span>}
          </h2>
          {fetching ? (
            ...
            <div className="space-y-3">
              {analyses.map((a) => (
                <div
                  key={a.id}
                  className="flex items-center gap-3 rounded-xl border border-slate-200 bg-white px-4 py-3 hover:border-slate-300 transition-colors cursor-pointer"
